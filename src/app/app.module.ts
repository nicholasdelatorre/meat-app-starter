...
import { RadioComponent } from './_shared/radio/radio.component';
...
@NgModule({
  ...
  imports: [
    ...
    HttpModule,
    FormsModule,
    RouterModule.forRoot(ROUTES) // Importar o ROUTES
  ],
  // Inserir os services no provider para injeção de dependencia
